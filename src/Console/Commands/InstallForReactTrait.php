...
trait InstallForReactTrait
{
    public function installForReact(): void
    {
        ...
        (new Filesystem)->copyDirectory(__DIR__ . '/../../Stubs/react/resources/js/components/builder', resource_path('js/components/builder'));
        $this->info('component copied successfully.');

        // copy inertia lib
        (new Filesystem)->copyDirectory(__DIR__ . '/../../Stubs/react/resources/js/lib', resource_path('js/lib'));
        $this->info('lib copied successfully.');

        // copy inertia builder pages
        (new Filesystem)->copyDirectory(__DIR__ . '/../../Stubs/react/resources/js/pages/builder', resource_path('js/pages/builder'));
        $this->info('page copied successfully.');

        // copy datatable and field builder type
        copy(__DIR__ . '/../../Stubs/react/resources/js/types/form.ts', resource_path('js/types/form.ts'));
        copy(__DIR__ . '/../../Stubs/react/resources/js/types/index.d.ts', resource_path('js/types/index.d.ts'));
        copy(__DIR__ . '/../../Stubs/react/resources/js/types/datatable.ts', resource_path('js/types/datatable.ts'));
        copy(__DIR__ . '/../../Stubs/react/resources/js/types/field-builder.ts', resource_path('js/types/field-builder.ts'));
        $this->info('datatable & field builder type copied successfully.');

        // copy css themes
        (new Filesystem)->copyDirectory(__DIR__ . '/../../Stubs/react/resources/css/theme', resource_path('css/theme'));
